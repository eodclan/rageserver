...
//Login module
  	sLogin: {    
		...
		annoucePlayerMenu: {
			...
			ger: 'Drücken Sie die Taste M, um das Menü zu öffnen',
			br: '', 
			zhs: 'M键开启菜单以获取更多帮助',
			zht: 'M鍵開啟菜單以獲取更多幫助。',
		},
...
//Vehicle module
	sVehicle: {
		...
		wantsSellVehicleToPlayer: {
			...
			ger: 'will dir ein Fahrzeug verkaufen',
			br: '', 
			zhs: '',
			zht: '',
		},
...
//GasStation module
	sGasStation: {
		...
		passengersDropOff: {
			...
			ger: 'Bitte geben Sie die Passagiere ab',
...
//Example mission CBDeliveryMen
	...
	sMenu: {
		wrongOldPass: {
			...
			ger: 'Sie haben ein falsches altes Passwort eingegeben',
			br: '', 
			zhs: '',
			zht: '',
		},
